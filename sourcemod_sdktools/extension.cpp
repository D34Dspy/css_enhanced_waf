...
// already defined in cstrike
// IBinTools *g_pBinTools = NULL;
extern ISDKTools *g_pSDKTools;

#if SOURCE_ENGINE >= SE_ORANGEBOX
// alrfeady defined in metamod:source
...
bool SDKTools_InvokeHk_IServerGameDll_LevelInit(char const *pMapName, char const *pMapEntities, char const *pOldLevel, char const *pLandmarkName, bool loadGame, bool background) {
	return g_SdkTools.LevelInit(pMapName, pMapEntities, pOldLevel, pLandmarkName, loadGame, background);
}

void SDKTools_InvokeHk_IServerGameDll_LevelShutdown(bool var) {
	return g_SdkTools.LevelShutdown();
}
...
bool SDKTools::SDK_OnLoad(char *error, size_t maxlength, bool late)
{
	...
	sharesys->AddDependency(myself, "./bin/sourcemodbintools", "./bin/libsourcemodbintools", false, true);
