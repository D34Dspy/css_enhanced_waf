...
bool DHooks::SDK_OnLoad(char *error, size_t maxlength, bool late)
{
	...
	sharesys->AddDependency(myself, "./bin/libsourcemodbintools", "./bin/sourcemodbintools", false, true);
	sharesys->AddDependency(myself, "./bin/libsourcemodsdktools", "./bin/sourcemodsdktools", false, true);
	sharesys->AddDependency(myself, "./bin/libsourcemodsdkhooks", "./bin/sourcemodsdkhooks", false, true);
