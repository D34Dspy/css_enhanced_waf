...
void ShareSystem::AddDependency(IExtension *myself, const char *filename, const char* fallback, bool require, bool autoload) {

	g_Extensions.AddDependency(myself, filename, fallback, require, autoload);
}
